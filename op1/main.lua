...
local function setSoftwallCheck(state)
    withModule("silent_aim", function(m)
        if type(m.setSoftwallCheck) == "function" then m:setSoftwallCheck(state) end
    end)
...
local function applyDefaults()
    ...
    setSilentAimTargetGadgets(false); setSilentAimVisibleCheck(false); setSoftwallCheck(false)
...
local function buildObsidianUi()
  local Window = Library:CreateWindow({
    ...
    AimL:AddToggle("SA_SoftwallCheck", {
        Text = "Softwall Check", Default = false,
        Tooltip = "Ignore parts tagged SoftWall when visibility checking",
        Callback = setSoftwallCheck,
    })
